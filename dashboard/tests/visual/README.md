...
- [`app/lib/dev-mock/install.ts`](../../app/lib/dev-mock/install.ts) — the canned responses every captured page renders against
- [dashboard/](../../README.md) — setup, dev server, and the rest of the test suites
- [Playwright docs](https://playwright.dev/docs/test-snapshots) — snapshot-testing reference
