# PrexorCloud for VS Code

MVP extension for working against a [PrexorCloud](../../..) controller without
leaving the editor.
...
This is the MASTER_PLAN 4.4 MVP. Not yet covered: creating/renaming/deleting
