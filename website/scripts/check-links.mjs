...
// Known non-markdown routes the checker can't see in the docs tree:
// /playground/ (Astro page) and /blog/rss.xml (emitted by src/pages/blog/rss.xml.ts).
const knownRoutes = new Set(['/', '/playground/', '/blog/rss.xml/']);
