...
```bash
prexorctl token create --node <unique-id>
...
- [`deploy/compose/`](../compose/README.md) — the single-host container alternative to these units
- [Rotating secrets](../../docs/runbooks/rotate-secrets.md) — cert rotation and node revocation
- [Upgrade runbook](../../docs/runbooks/upgrade.md) — rolling a host install to a new version
