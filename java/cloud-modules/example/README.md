...
1. Copy `java/cloud-modules/example` to
   `java/cloud-modules/<your-name>`.
...
6. Build the module JAR with `./gradlew
   :cloud-modules:<your-name>:assemble`.
...
```bash
# Linux/macOS
./gradlew :cloud-modules:example:test

# Windows
gradlew.bat :cloud-modules:example:test
```
