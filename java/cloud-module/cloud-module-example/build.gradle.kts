...
prexorcloudModule {
    ...
    extensionArtifacts.set(
        mapOf(
            "extensions/server/folia/example-playtime-folia.jar" to ":cloud-module:cloud-module-example:plugin:folia",
            "extensions/proxy/velocity/example-playtime-velocity.jar" to ":cloud-module:cloud-module-example:plugin:velocity",
            "extensions/server/paper/example-playtime-paper.jar" to ":cloud-module:cloud-module-example:plugin:paper",
            "extensions/server/bedrock-geyser/example-playtime-bedrock-geyser.jar"
                to ":cloud-module:cloud-module-example:plugin:bedrock-geyser",
        ),
    )
}
