...
prexorcloudModule {
    ...
    extensionArtifacts.set(
        mapOf(
            "extensions/server/paper/tablist-paper.jar" to ":cloud-module:cloud-module-tablist:plugin:paper",
            "extensions/server/folia/tablist-folia.jar" to ":cloud-module:cloud-module-tablist:plugin:folia",
        ),
    )
}
