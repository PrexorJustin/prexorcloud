...
prexorcloudModule {
    ...
    extensionArtifacts.set(
        mapOf(
            "extensions/server/paper/1.20/protocol-tap-paper-v1_20.jar" to ":cloud-module:cloud-module-protocol-tap:plugin:paper:v1_20",
            "extensions/server/paper/1.21/protocol-tap-paper-v1_21.jar" to ":cloud-module:cloud-module-protocol-tap:plugin:paper:v1_21",
            "extensions/server/folia/protocol-tap-folia.jar" to ":cloud-module:cloud-module-protocol-tap:plugin:folia",
        ),
    )
}
