...
/**
 * Daemon-side {@link TaskScheduler}. Wraps a daemon-owned {@link ScheduledExecutorService};
 * tasks scheduled by daemon modules share its lifecycle and are cancelled when the daemon
 * shuts the executor down.
 */
public final class DaemonTaskScheduler implements TaskScheduler {

    private final ScheduledExecutorService executor;

    public DaemonTaskScheduler(ScheduledExecutorService executor) {
