...
- **Pending live re-validation** (destructive — re-tangles the quorum; batch when convenient): #2-majority-loss 503, #4 leave-then-restart fence, #3 reset audit + clusterId preservation. #2-CLI-eject can be checked live now.
