...
### F.1 First-Class Bedrock-Routing (~7 d) — ⏳ **Sichtbarkeit + Edition-Routing + Geyser-Sidecar (code) shipped; Daemon-Provisioning + Laufzeit-Verifikation offen**
