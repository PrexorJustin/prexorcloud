...
### H.3 i18n-Coverage (~3 d) — ✅ **Dashboard vollständig extrahiert; Website-DE offen**
...
- Dashboard: 100 % der UI-Strings extrahiert in `i18n/en.json`, `i18n/de.json`.
  ...
  - **Nächster Schritt:** Der `i18n:check`-Gate kann jetzt um eine „keine hardcodeten user-facing Strings"-Lint erweitert werden (das Hardcode-Inventar ist auf null).
