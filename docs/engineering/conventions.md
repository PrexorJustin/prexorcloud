...
- **Java 25 (preview)** — Controller, daemon, common, protocol, security (cutting-edge features)
- **Java 21** — API module (stable, no preview — ensures plugins can compile without preview flags)
- **Java 17** — Plugins (Minecraft server compatibility — servers run Java 17+)
