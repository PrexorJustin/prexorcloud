...
- **Remaining — deploy-back** ("save running instance → new template version"): a substantial new backend feature (daemon file-snapshot + template versioning) that wants a design pass before building.
