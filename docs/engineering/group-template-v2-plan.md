...
- **Next — Inc 3:** CANARY as a first-class strategy (bake one, observe crash + TPS regression via `InstanceInfo.tps1m`, then proceed or auto-rollback). Then Inc 4: rollback/pause/resume UX (CLI/Dashboard) + deploy-back.
